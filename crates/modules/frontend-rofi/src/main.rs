...
const MODULE_ID: &str = "frontend-rofi";
const MENU_BIN: &str = "rofi";
const FIXED_ARGS: &[&str] = &["-dmenu", "-i", "-p", "cliphistory"];
...
fn main() -> std::process::ExitCode {
    ...
    // Everything after `run` is passed through to rofi (e.g. `-theme ...`).
